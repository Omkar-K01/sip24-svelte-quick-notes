  ...
  <div class= "bg-light-gray overflow-y-auto py-5 px-3 h-full border-r border-gray-200">
    <ul class= "space-y-2">
      ...
      <li>
        ...
        <button on:click ={()=>delPage(index)} class= "text-red-500 ml-2">&#x2716;</button>
      </li>
      {/each}
...
<main class="p-4 ml-60 h-auto">
  <div class=" grid grid-cols-2 item-center mb-4">
    ...
    <button class=" ml-auto bg-gray-600 text-white px-5 py-2.5 rounded-lg font-medium text-sm mt-3 hover:bg-gray-900"on:click={saveNote}>Save</button>
  </div>
  <hr/>
